...
/***************************************************/
void StartADDA(int gain, int rate, int mode);
void StopADDA(void);
void ReadADC(void);
...
*	parameter: _ucDiffMode : 0  Single-ended input  8 channels 1 Differential input  4 channe
*	The return value: NULL
*********************************************************************************************************
*/
void ADS1256_StartScan(uint8_t _ucScanMode)
...
*	The return value:  voltage converted to uint16
*********************************************************************************************************
*/
uint16_t Voltage_Convert(float Vref, float voltage)
{
...
*********************************************************************************************************
*	name: StartADDA
*	function: Start ads1256 and dac8532
*	parameter: gain:
*			   sampling_rate:
*			   scan_mode:
*	The return value:  NULL
...
*********************************************************************************************************
*	name: StopADC
*	function: Stop ads1256 and dac8532
*	parameter: NULL
*	The return value:  NULL
*********************************************************************************************************
*/
...
*	parameter: ch_id:
*	The return value:  adc value
*********************************************************************************************************
*/
long int GetChannelRaw(int ch_id)
{
	return (long int)ADS1256_GetAdc(ch_id);
}

/*
*********************************************************************************************************
*	name: GetChannelVolts
*	function: Read channel and convert to voltage
*	parameter: ch_id:
*	The return value:  volt value
*********************************************************************************************************
*/
double GetChannelVolts(int ch_id)
{
...
*********************************************************************************************************
*	name: WriteVolts
*	function: Outputs a voltage to a DA channel
*	parameter: ch_id:
* 			   volts:
*			   vRef:
*	The return value:  NULL
